  ...
  (0, import_react.useEffect)(
    () => {
      ...
      if (reuseMaps && CachedMapStack.has(cacheKey)) {
        ...
        container.appendChild(mapDiv);
        map2 = new google.maps.Map(mapDiv, _extends({}, mapOptions, {
          renderingType,
          colorScheme
        }));
      }
...
function useAdvancedMarker(props) {
  ...
  (0, import_react.useEffect)(() => {
    if (!marker) return;
    if (clickable !== void 0) marker.gmpClickable = clickable;
